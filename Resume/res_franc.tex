...
% France\\\{alejandro.reyes, eric.monfroy, florian.richoux\}@univ-nantes.fr} 
 ...
 \institutions{LINA - UMR 6241, TASC - INRIA Universit\'{e} de Nantes, France.}

 \mels{alejandro.reyes@univ-nantes.fr}
...
Le bénéfice de l'approche en  parallèle avec \posl{} est aussi prouvé pour le \GRP{} (voir les tableaux~\ref{tab:golomb_seq} et~\ref{tab:golomb_par}). Dans ces tableaux, la colonne \textbf{R} représente le nombre de redémarrages exécutées. Cette expérience a été réalisée en utilisant des solveurs similaires à ceux présentés précédemment, mais sans \opchs.
...
\begin{tabular}{p{1.4cm}|R{0.9cm}R{1.2cm}R{0.8cm}}
	...
	\hline
\end{tabular}
\caption{Résultats avec communication \oneTone{} pour \GRP.}
...
\begin{tabular}{p{1.4cm}|R{1cm}R{1.3cm}R{0.8cm}}
	...
	\hline
\end{tabular}
\caption{Résultats avec communication \oneTn{} pour pour \GRP.}
