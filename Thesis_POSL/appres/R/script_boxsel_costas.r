...
dev=pdf("c19_select_BP.pdf", height=14, width=21)
par(cex.axis=2)
...
lablist.y<-as.vector(c("Sequential", "Parallel without communciation"))
...
legend(	'topright', 
			c("Sequential mean", "Parallel without communication mean"), 
			lty=2, lwd=4,
			col=c("red", "blue"), 
