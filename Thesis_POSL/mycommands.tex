...
\newcommand{\onetoone}{\insquare[4pt]{$\rightarrow$}[0.5pt]} %{$\text{ }\Aboxed{\rightarrow}\text{ }$} %{\poslop{\rightarrow}}
\newcommand{\onetoonesep}{\ \insquare[4pt]{$\rightarrow$}[0.5pt]\ }
%\newcommand{\onetoonesep}{\quad\insquare[4pt]{$\rightarrow$}[0.5pt]\quad}
\newcommand{\oneton}{\insquare[4pt]{$\rightsquigarrow$}[0.5pt]} %{\poslop{\rightsquigarrow}}
\newcommand{\onetonsep}{\ \insquare[4pt]{$\rightsquigarrow$}[0.5pt]\ }
\newcommand{\ring}{\insquare[4pt]{$\leftrightarrow$}[0.5pt]} 
\newcommand{\ringsep}{\ \insquare[4pt]{$\leftrightarrow$}[0.5pt]\ }
...
\newcommand{\cop}{combinatorial optimization problem}
\newcommand{\cops}{\cop s}
\newcommand{\COPs}{\COP s}
\newcommand{\CSP}{Constraint Satisfaction Problem}
\newcommand{\CSPs}{\CSP s}
\newcommand{\csp}{CSP}
\newcommand{\csps}{\csp s}
\newcommand{\CP}{Constraint Programing}
\newcommand{\cp}{constraint programing}
\newcommand{\choco}{\texttt{Choco}}

\newcommand{\sg}{Social Golfers}
\newcommand{\sgp}{\sg{} Problem}
\newcommand{\SGP}{SGP}
\newcommand{\nq}{N-Queens}
\newcommand{\nqp}{\nq{} Problem}
\newcommand{\NQP}{NQP}
\newcommand{\carr}{Costas Array}
\newcommand{\carrp}{\carr{} Problem}
\newcommand{\CARRP}{CAP}
\newcommand{\gr}{Golomb Ruler}
\newcommand{\grp}{\gr{} Problem}
\newcommand{\GRP}{GRP}
...
%\newsavebox{\mycode}
\SetKwFor{While}{$[\circled{$\circlearrowleft$} $}{}{$]$} %{\tet{\bf begin}}{\tet{\bf end}$]$}
...
\newcommand{\cycop}{\circled{$\circlearrowleft$}}
\newcommand{\whileinline}[2] {$[\cycop$ #1 #2 $\left.\right]$}%{$[\circlearrowleft $ #1 \tet{\bf begin} #2 \tet{\bf end}$]$}
...
\newcommand{\poslcaptiondesciption}[1]{
{\fontsize{10pt}{12pt}\fontfamily{phv}\selectfont #1}
}
...
\newtheorem{lemma}[theorem]{Définition}
