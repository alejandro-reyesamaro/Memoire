...
were performed on an Intel\R{} Xeon\TM{} E5-2680 v2, 10$\times$4 cores, 2.80GHz. This server is called {\sc Curiosiphi} and is located at \textit{Laboratoire d'Informatique de Nantes Atlantique}, at the University of Nantes. %The other term that needs to be introduced is the \textit{statistical summary}, which is the obtained information from the runs, used to analyze the solution process and draw conclusions.
