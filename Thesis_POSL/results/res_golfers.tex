...
%\subitem This strategy did not show better results than previews strategies: more than two time worse than sequential results, for every instance. The reason is because, although the communication in \posl{} is asynchronous, most of the times solvers were trapped waiting for a configuration coming from its neighbor solver.
%
