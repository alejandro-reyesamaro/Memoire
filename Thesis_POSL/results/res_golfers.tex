...
\new{The \om{} $I_{BP}$ generates an initial configuration $s$ respecting the structure of the problem's model, \ie the configuration $s$ is a set of $w$ permutations of the vector $[1..P]$, where $P=g\times p$. The configuration $s$ is the input of the \m{} in the Step 2.}
