...
\new{The \om{} $I_{perm}$ generates an initial configuration $s$ respecting the structure of the problem's model, \ie the configuration $s$ is a permutation of the vector $[1..N]$. The configuration $s$ is the input of the \m{} in the Step 2.}
