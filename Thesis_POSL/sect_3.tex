...
\end{list}
These modules are used and explained in details in the Chapter~\ref{chap:expe} of this document. Algorithm~\ref{algo:solver_def} implements Algorithm~\ref{algo:as_example} by instantiating its modules.
}
