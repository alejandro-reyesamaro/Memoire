...
$$\left[S\right] \poslop{\rightsquigarrow} \left[Z\right]$$
...
$$\left[S_1, S_2, S_3\right]\poslop{\rightsquigarrow} \left[Z_1, Z_2, Z_3\right]$$
...
\SetNoline
%\myproc{
[ S$\cdot A$ (3) ] $\poslop{\rightsquigarrow}$ [ Z$\cdot CM_{last}$ (3) ] 2 ;
