...
\modified{One of the goals of \posl{} is to provide a way to declare sets of solvers to be executed in parallel fast and easily. For that reason, \posl{} provides two ways of name space expansion, in order to create sets of solvers using already declared ones:}
